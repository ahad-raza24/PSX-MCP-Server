...
from psx_mcp.models import StockData, TimeSeriesData  # noqa: E402
...
class TestMCPTools:
    ...
    async def test_get_market_watch_tool_success(self):
        ...
        with patch(
            "psx_mcp_server.psx_client.get_market_watch_data", return_value=mock_data
        ):
    ...
    async def test_get_market_watch_tool_failure(self):
        ...
        with patch(
            "psx_mcp_server.psx_client.get_market_watch_data",
    ...
    async def test_get_stock_intraday_data_tool_success(self):
        ...
        with patch(
            "psx_mcp_server.psx_client.get_intraday_data", return_value=mock_data
        ):
    ...
    async def test_get_stock_intraday_data_tool_failure(self):
        ...
        with patch(
            "psx_mcp_server.psx_client.get_intraday_data",
            side_effect=Exception("API Error"),
        ):
    ...
    async def test_get_stock_eod_data_tool_failure(self):
        ...
        with patch(
            "psx_mcp_server.psx_client.get_eod_data", side_effect=Exception("API Error")
        ):
...
class TestDataModels:
    ...
    def test_time_series_data_model(self):
        ...
        intraday = TimeSeriesData(timestamp=1759491298, price=300.87, volume=1000)
        ...
        eod = TimeSeriesData(
            timestamp=1759489200, price=300.87, volume=2024970, open_price=305.0
        )
